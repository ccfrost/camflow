...
func TestLoadConfig_EnvVars(t *testing.T) {
	...
	configContent := `
photos_to_process_root = "/tmp/photos"
[google_photos]
...
`
	...
	t.Setenv("CAMFLOW_PHOTOS_TO_PROCESS_ROOT", "/env/photos")
	...
	assert.Equal(t, "/env/photos", cfg.PhotosToProcessRoot, "Environment variable should override config file for top level field")
}
